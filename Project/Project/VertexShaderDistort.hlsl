...
S_VSOUTPUT main(S_VSINPUT _input)
{
	...
	output.pos.x = sin(_input.pos.x * t);
	output.pos.y = sin(_input.pos.y * t);
	output.pos.z = sin(_input.pos.z * t);
	output.pos = mul(output.pos, instanceOffsets[_input.instanceID]);
